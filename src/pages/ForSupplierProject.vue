  ...
  <q-page padding>
    ...
    <q-card class="q-pa-md">
      ...
      <div class="row items-center justify-between q-mb-md">
        <div class="text-h6 q-mb-sm">List of Projects</div>
        <q-btn
          label="Apply"
          color="green"
          text-color="white"
      ...
      <div class="lt-sm">
        <template v-if="paginatedRows.length">
          <q-card v-for="project in paginatedRows" :key="project.uniqueId" flat bordered class="mobile-card">
            <q-card-section>
              <div class="row items-center justify-between q-mb-sm">
                <div class="text-subtitle2">{{ project.dateCreated }}</div>
                <div class="text-right">
                  <div class="text-subtitle2 text-grey-7">Status</div>
                  <div :class="getStatusColorClass(project.status)">{{ project.status }}</div>
                </div>
              </div>
              ...
              <div class="q-gutter-y-sm">
                ...
                <div>
                  <div class="text-caption text-grey-7">Project Type</div>
...
const projects = ref([
  ...
  },
  {
    ...
    projectType: 'Security Implementation',
...
const onRequest = (props) => {
  ...
  pagination.value = {
    ...
    sortBy,
    descending,
    rowsNumber: filteredProjects.value.length
  }
}
...
const filteredProjects = computed(() => {
  ...
  return projects.value.filter(project =>
    ...
    project.dateCreated.toLowerCase().includes(searchLower)
  )
})
...
const totalRows = computed(() => filteredProjects.value.length)
